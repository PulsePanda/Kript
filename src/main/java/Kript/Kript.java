...
public class Kript {
    ...
    /**
     * Default constructor. Creates the Keypair for use
     *
     * @throws NoSuchAlgorithmException if there is an issue with creating the RSA keys.
     */
...
//		 remotePublicKey = key.getPublic();
     ...
     *
     * @param encryptedMessage byte[] containing encrypted byte message
     * @return byte[] array containing message values
     * @throws Exception if there is an issue creating RSA cipher to decrypt.
     */
     ...
     * size to be encoded.
     *
     * @param bytes  byte[] array containing either plain or encoded data.
     * @param cipher Cipher object containing the mode, and related key.
